...
const SimpleLoadingSkeleton = () => (
  <div className="simple-loading" style={{
    minHeight: '100vh',
    background: '#fafafa',
    display: 'flex',
    alignItems: 'center',
...
const fetchMetadata = async () => {
  try {
    ...
    return {
      meta_title: data.meta_title || "Dream Tourism SRLS - Your Place for Amazing Travel Adventure",
      meta_description: data.meta_description || "Start your dream vacation with Dream Tourism SRLS. Explore fantastic destinations and enjoy unforgettable adventures. Your perfect getaway is just a click away!",
      ...
      keywords: data.keywords || "Italy tours, Rome tours, Vatican tours, Tuscany tours, Amalfi Coast, skip-the-line tickets, day trips from Rome, Florence tours, Venice tours",
      ...data
    };
  } catch (error) {
    ...
    return {
      meta_title: "Dream Tourism SRLS - Your Place for Amazing Travel Adventure | Italy Tours",
      meta_description: "Start your dream vacation with Dream Tourism SRLS. Explore fantastic destinations including Rome, Vatican, Tuscany, and Amalfi Coast. Skip-the-line tickets, expert guides, unforgettable adventures. Your perfect Italy getaway is just a click away!",
      cloudflare_image: "https://imagedelivery.net/dIKhvGtesTiRSxhQ2oKWkA/5dbac07d-cbd4-4694-9a38-615bf832f800/public",
      keywords: "Italy tours, Rome tours, Vatican tours, Tuscany tours, Amalfi Coast tours, skip-the-line tickets, day trips from Rome, Florence tours, Venice tours, Pompeii tours, Cinque Terre tours"
    };
  }
};
      ...
      <style dangerouslySetInnerHTML={{
        __html: `
          ...
          @media(max-width:768px){
            .hero-skeleton{min-height:400px}
